...
const categories = [
  ...
  },
  {
    name: "Turbodelar",
    type: "list",
    subcategories: ["Kompressorhjul", "Turbinhjul", "Lagerhus", "Packningar & tätningar", "Aktuatorer"],
  },
  {
  ...
  },
  {
    name: "Prestanda",
    type: "list",
    subcategories: ["Intercoolers", "BOV & wastegates", "Grenrör", "Downpipes"],
  },
  {
    name: "Katalog",
    type: "link",
  ...
  return (
    <header className="bg-white border-b border-gray-200 sticky top-0 z-50">
      ...
      <div className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between gap-4">
        ...
        <Link href="/cart" className="flex items-center gap-2 bg-red-600 hover:bg-red-700 text-white px-4 py-2 rounded-md transition">
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z" />
          </svg>
          <span className="text-sm font-medium">Varukorg (0)</span>
        </Link>
      </div>
                    ...
                    <div className="grid grid-cols-4 gap-2">
                      {brandLogos.map((brand) => (
                        <Link
                          ...
                          className="group flex items-center justify-center bg-gray-50 border border-gray-200 rounded-lg p-2 hover:border-red-400 hover:bg-red-50 transition"
                          style={{ height: 60 }}
                        >
                          <img
                            src={brand.logo}
